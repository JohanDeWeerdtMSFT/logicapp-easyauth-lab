...
Once you've completed testing and collected all evidence, you have several options for cleanup:

### **Undeploy Option**: ❌ No built-in undeploy, but you can:

**Option A: Remove Everything (Fastest)**
...
- ✅ Virtual networks
- ✅ Private endpoints
- ✅ All other resources in that resource group
...
**Option C: Delete Specific Resources (Selective)**

If you want to keep the infrastructure but remove only the Function App:
...
- **Storage accounts** incur costs even when not actively used
- **Virtual networks** and **private endpoints** incur hourly charges  
- **Function Apps** have consumption-based pricing

**Recommendation:** If testing is complete and you're not planning to re-run, delete the resource group entirely to avoid unexpected charges.
