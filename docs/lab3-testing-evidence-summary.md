# Lab 3 — Complete Testing & Evidence Collection Summary

**Date:** 2026-07-03  
**Status:** All infrastructure deployed, testing documentation complete

---

## 🎯 Your Question Answered

**You asked:** "If all code (infra and actual apps) work fully, show me how I can 'test' it and the proof (or evidence)"
...
### 1️⃣ **Infrastructure** (Deployed ✅)

- **Resource Group:** `rg-la-easyauth-lab-dev`
- **17 resources deployed:**
  - Function App (S1 plan) with system-assigned managed identity
  - Logic App Standard (WS1 plan) with Easy Auth configured
  - Virtual Network (10.0.0.0/16) with two subnets
  - Private Endpoints + Private DNS Zone
  - Storage, App Insights, NAT Gateway

✅ All infrastructure is live in Azure. Ready to test.

### 2️⃣ **Reference Source Code** (Complete Documentation)

The repository contains **complete C# code examples** showing exactly how to build the Function App:

| Document | Location | Contains |
|----------|----------|----------|
| **Testing Guide** | [`docs/lab3-testing-and-verification.md`](docs/lab3-testing-and-verification.md) | Complete step-by-step testing instructions with full C# HttpTrigger implementation |
| **Quick Reference** | [`docs/lab3-quick-reference-card.md`](docs/lab3-quick-reference-card.md) | Printable checklist, code patterns, error troubleshooting |
| **Markdown Docs** | [`docs/lab3-managed-identity-bearer-token-flow.md`](docs/lab3-managed-identity-bearer-token-flow.md) | Architecture, JWT anatomy, 6-step flow, error scenarios |
| **HTML Docs** | [`documentation/architecture/lab3-bearer-token-flow.html`](documentation/architecture/lab3-bearer-token-flow.html) | Interactive documentation with Mermaid diagrams, code examples |

### 3️⃣ **Bicep Infrastructure** (Ready to Review)

| Module | Location | Purpose |
|--------|----------|---------|
| Function App | [`infra/modules/functionapp-caller.bicep`](infra/modules/functionapp-caller.bicep) | S1 plan, VNet integration, MI setup |
| Logic App | [`infra/modules/logicapp.bicep`](infra/modules/logicapp.bicep) | WS1 plan, public network access disabled |
| Easy Auth | [`infra/modules/easyauth.bicep`](infra/modules/easyauth.bicep) | AllowAnonymous + allowedPrincipals filter |
| Networking | [`infra/modules/networking.bicep`](infra/modules/networking.bicep) | VNet, subnets, private DNS, private endpoints |

All Bicep is referenced in the documentation with embedded code snippets.
