...
![Azure portal Add a scope pane configured for the user_impersonation delegated scope](images/step-5-prereq-add-delegated-scope.png)
...
![Azure portal Add a client application pane with the user_impersonation scope checkbox selected](images/step-5-prereq-preauthorize-azure-cli.png)
...
![Logic App Easy Auth identity provider with two specific allowed identities configured](images/step-7-temporarily-allow-lab-user.png)
